...
import { ArrowRight, CheckCircle, Flame, ThermometerSun, Wrench } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-fadeIn">
              Keep Your Home Warm and Cozy with Our Heating Experts
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8 animate-fadeIn">
              Boiler Repairs, Central Heating Installations, and More
            </p>
            <div className="flex flex-col items-center gap-6 mb-8 animate-fadeIn">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white text-left">
                <div className="flex items-center gap-2">
                  ...
                  <span>Boiler Specialists</span>
                </div>
                <div className="flex items-center gap-2">
                  <ThermometerSun className="w-5 h-5 text-accent" />
                  <span>Central Heating Experts</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Boiler Services</h3>
              <p className="text-gray-600">Expert boiler repairs, maintenance, and installations.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Central Heating</h3>
              <p className="text-gray-600">Complete central heating system installation and maintenance.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Emergency Repairs</h3>
              <p className="text-gray-600">24/7 emergency heating repair service when you need it most.</p>
            </div>
          </div>
        </div>
      </div>
