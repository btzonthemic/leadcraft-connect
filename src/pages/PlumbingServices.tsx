...
import { ArrowRight, CheckCircle, Clock, Wrench, ShowerHead } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-fadeIn">
              Your Trusted Local Plumbers – Available 24/7
            </h1>
            ...
            <div className="flex flex-col items-center gap-6 mb-8 animate-fadeIn">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white text-left">
                ...
                <div className="flex items-center gap-2">
                  <ShowerHead className="w-5 h-5 text-accent" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">24/7 emergency service for leaks, blockages, and burst pipes.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Installation Services</h3>
              <p className="text-gray-600">Expert installation of bathrooms, kitchens, and appliances.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Maintenance</h3>
              <p className="text-gray-600">Regular maintenance to prevent costly repairs and extend system life.</p>
            </div>
          </div>
        </div>
      </div>
